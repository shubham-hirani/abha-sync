...
const Navbar = ({ onLogout }) => {
  ...
  return (
    <nav className="glass border-b border-white/20 p-4 lg:p-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative">
            ...
            {showNotifications && (
              <div className="absolute right-0 top-12 w-80 glass border border-white/20 rounded-2xl p-4 shadow-2xl z-50">
          ...
          <div className="relative">
            ...
            {showProfileMenu && (
              <div className="absolute right-0 top-12 w-48 glass border border-white/20 rounded-2xl p-2 shadow-2xl z-50">

...
export default function MyRecords() {
    ...
    const urgencyColor: { [key: string]: string } = {
        ...
        urgent: "#ef4444",
        not_needed: "#22c55e",
        routine_checkup: "#22c55e",
        within_a_week: "#f59e0b",
        see_doctor_soon: "#ef4444",
        emergency: "#dc2626",
    };
    ...
    const urgencyLabel: { [key: string]: string } = {
        ...
        urgent: "🔴 Urgent — see doctor",
        not_needed: "🟢 No doctor visit needed",
        routine_checkup: "🟢 Routine checkup recommended",
        within_a_week: "🟡 Visit within a week",
        ...
        try {
            ...
            return (
                <div className="ai-insights">
                    ...
                    {/* ── Generic: What this means for you ── */}
                        ...
                        <div className="ai-section">
                            ...
                            {data.parameters.map((p: any, i: number) => (
                                <div key={i} className={`ai-param-card ai-param-${p.status}`}>
                                    ...
                                    {p.plain_meaning && (
                                        <p className="ai-param-meaning">{p.plain_meaning}</p>
                                    )}
                    ...
                    {/* ── LAB REPORT: Abnormal Findings ── */}
                    {isLabReport && data.abnormal_findings?.length > 0 && (
                        <div className="ai-section">
